import os, sys
import numpy as np
from kondo3_cam_model import CameraModel
...
class RobotModel:
    def __init__(self, glob):
        ...
        self.base_height = self.glob.params['HEIGHT_OF_CAMERA']/1000
        ...
        self.camera_pan = 0
        self.camera_tilt = 0
        self.camera_model = CameraModel(self.glob)
    ...
    def update_camera_pan_tilt(self, camera_pan, camera_tilt):
        ...
        print(f"self.camera_pan = {self.camera_pan}, self.camera_tilt = {self.camera_tilt}, self.robot_height = {self.robot_height}")
    ...
    def image2self(self, pixel_x, pixel_y, height):
        ...
        print(self_vec)
        print(self.neck_height * np.sin(-self.camera_tilt) * np.cos(self.camera_pan))
        print(self.neck_height * np.sin(-self.camera_tilt) * np.sin(self.camera_pan))
