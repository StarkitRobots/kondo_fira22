...
class Pose_Designer(wx.Frame):
    ...
    def __init__(self, *args, **kw):
        ...
        self.jointLimits = [(-3500,700),(-3800, 3500),(-4600, 1800),(-3400,3400),(-2700,860),(-2400,2800),(-700,3800),(-3000,4000),(-5800,900), (-6500, 2800),(-2500,2500),
                            (-700,3500),(-3500, 3800),(-1800, 4600),(-3400,3400),(-860,2700),(-2800,2400),(-3800,700),(-4000,3000),(-900,5800), (-2800, 6500), (-8000, 8000), (-8000, 8000), (-8000, 8000), (-8000, 8000), (-3000, 3000), (-3000, 3000)]
